...
@interface DocumentsGridDatasource(Private)
...
@implementation DocumentsGridDatasource
@synthesize docListView, allDocuments, sortDescriptors;
...
@implementation DocumentsGridDatasource(Private)
- (void)documentsAdded:(NSNotification *)notification
{
