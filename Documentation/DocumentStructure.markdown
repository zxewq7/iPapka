...
Под понятием файлового поля понимается объект, состоящий из полей:
		...
		,"files": [{
			 ...
			 [ 
				{ 
			      ...
			      "audio"": [{"id":"id","version":"version"}, {"id":"id","version":"version"}]
				}, 
				{ 
			      "pageNum": 1, 
			      "drawing": {"id":"id","version":"version"},
...
* **document** - обязательный объект со следующей структурой:
	...
	* **files** - обязательный непустой массив вложений для резолюции со следующей структурой:
		...
		* **resources** - массив файловых полей рисований и аудио комментариев к страницам  со следующей структурой:
			* **pageNum** - обязательный числовой номер страницы, к которой относятся данные ресурсы
			* **drawing** - файловое поле рисования к странице
			* **audio** - массив файловых полей аудио комментариев к странице
...
* **document** - обязательный объект со следующей структурой:
	* **regDate** - обязательная  дата создания документа в формате **yyyyMMdd**
	* **corrs** - массив строк корреспондентов
