...
* в очереди **необработанные документы** документы должны группироваться по дате получения документа с сервера по убыванию. Внутри каждой группы сортировка идет по убыванию важности (поле **priority**) и по убыванию времени получения.
